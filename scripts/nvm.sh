...
sudo su vagrant -c '. ~vagrant/.nvm/nvm.sh;nvm install v6.0.0'
sudo su vagrant -c '. ~vagrant/.nvm/nvm.sh;nvm use v6.0.0'
sudo su vagrant -c '. ~vagrant/.nvm/nvm.sh;nvm alias default v6.0.0'
